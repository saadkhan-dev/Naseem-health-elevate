...
const PHRASE_MAP: Readonly<Record<string, string>> = {
  ...
  // Everyday natural-phrasing additions (context-aware consultation speech)
  "مجھے یہ درد تین دن سے ہو رہا ہے.": "Mujhe ye dard teen din se ho raha hai.",
  "مجھے یہ درد تین دن سے ہو رہا ہے": "Mujhe ye dard teen din se ho raha hai",
  "درد رات کو زیادہ ہوتا ہے.": "Dard raat ko zyada hota hai.",
  "درد رات کو زیادہ ہوتا ہے": "Dard raat ko zyada hota hai",
  "کیا درد چلنے سے بڑھتا ہے?": "Kya dard chalne se barhta hai?",
  "کیا درد بیٹھنے سے بڑھتا ہے?": "Kya dard baithne se barhta hai?",
  "کیا درد اٹھتے وقت زیادہ ہوتا ہے?": "Kya dard uthate waqt zyada hota hai?",
  "کیا آپ سیڑھیاں چڑھ سکتے ہیں?": "Kya aap seerhiyan charh sakte hain?",
  "مجھے سیڑھیاں چڑھنے میں مشکل ہوتی ہے.": "Mujhe seerhiyan charhne mein mushkil hoti hai.",
  "مجھے سیڑھیاں چڑھنے میں مشکل ہوتی ہے": "Mujhe seerhiyan charhne mein mushkil hoti hai",
  "درد دائیں ٹانگ تک پھیل رہا ہے.": "Dard dayen tang tak phail raha hai.",
  "درد دائیں ٹانگ تک پھیل رہا ہے": "Dard dayen tang tak phail raha hai",
  "میری ٹانگ سن ہو جاتی ہے.": "Meri tang sun ho jati hai.",
  "میری ٹانگ سن ہو جاتی ہے": "Meri tang sun ho jati hai",
  "میں زیادہ دیر بیٹھ نہیں سکتا.": "Mein zyada dair baith nahi sakta.",
  "میں زیادہ دیر بیٹھ نہیں سکتا": "Mein zyada dair baith nahi sakta",
  "کیا آپ کی نیند ٹھیک آتی ہے?": "Kya aap ki neend theek aati hai?",
  "مجھے نیند نہیں آ رہی.": "Mujhe neend nahi aa rahi.",
  "مجھے نیند نہیں آ رہی": "Mujhe neend nahi aa rahi",
  "بھوک کم لگتی ہے.": "Bhukh kam lagti hai.",
  "بھوک کم لگتی ہے": "Bhukh kam lagti hai",
  "میں چل نہیں سکتا.": "Mein chal nahi sakta.",
  "میں چل نہیں سکتا": "Mein chal nahi sakta",
  "سانس پھولتی ہے.": "Saans phoolti hai.",
  "سانس پھولتی ہے": "Saans phoolti hai",
  "میرا بلڈ پریشر بڑھ گیا ہے.": "Mera blood pressure barh gaya hai.",
  "میرا بلڈ پریشر بڑھ گیا ہے": "Mera blood pressure barh gaya hai",
  "شوگر زیادہ ہو گئی ہے.": "Sugar zyada ho gayi hai.",
  "شوگر زیادہ ہو گئی ہے": "Sugar zyada ho gayi hai",
  "دوا ختم ہو گئی ہے.": "Dawa khatam ho gayi hai.",
  "دوا ختم ہو گئی ہے": "Dawa khatam ho gayi hai",
  "مجھے کھانا کھانے کے بعد درد ہوتا ہے.": "Mujhe khana khaane ke baad dard hota hai.",
  "مجھے کھانا کھانے کے بعد درد ہوتا ہے": "Mujhe khana khaane ke baad dard hota hai",
  "آپ کو اسپتال جانا پڑے گا.": "Aap ko hospital jana pare ga.",
  "آپ کو اسپتال جانا پڑے گا": "Aap ko hospital jana pare ga",
  "میری کمر اکڑ جاتی ہے.": "Meri kamarr akarh jati hai.",
  "میری کمر اکڑ جاتی ہے": "Meri kamarr akarh jati hai",
  "مجھے صبح کے وقت تکلیف زیادہ ہوتی ہے.": "Mujhe subah ke waqt takleef zyada hoti hai.",
  "مجھے صبح کے وقت تکلیف زیادہ ہوتی ہے": "Mujhe subah ke waqt takleef zyada hoti hai",
  "درد میں جھنجھناہٹ بھی ہوتی ہے.": "Dard mein jhunjhunaht bhi hoti hai.",
  "درد میں جھنجھناہٹ بھی ہوتی ہے": "Dard mein jhunjhunaht bhi hoti hai",
  "دوا کی خوراک کتنی ہے?": "Dawa ki khorak kitni hai?",
  "آپ نے کون سی دوا لی تھی?": "Aap ne kaun si dawa li thi?",
};
...
const DICTIONARY: Readonly<Record<string, string>> = {
  ...
  // Movement & everyday activity (walking / stairs / postures)
  چل: "chal",
  چلنا: "chalna",
  چلنے: "chalne",
  چلتا: "chalta",
