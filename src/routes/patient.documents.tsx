      ...
      <div className="rounded-2xl border border-border bg-card p-5 shadow-soft">
        ...
        <div className="mt-3 grid gap-2 sm:grid-cols-[1fr_auto]">
          ...
          <div className="flex gap-2">
            <Button asChild className={cn("h-11", uploading && "pointer-events-none opacity-60")}>
...
function DocumentStatusBadge({ status }: { status: PatientDocumentStatus }) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 rounded-full px-2 py-1 text-[11px] font-medium ${c.className}`}
    >
